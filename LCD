...
void setup(void) {
  ...
  Serial.print(F("Loading loser.bmp to screen..."));
  stat = reader.drawBMP("/loser.bmp", tft, 0, 0);
  ...
  stat = reader.bmpDimensions("/loser.bmp", &width, &height);
  reader.printStatus(stat);   // How'd we do?
